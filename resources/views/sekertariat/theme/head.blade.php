    ...
    <div id="eis_all" >
        <div>
            <div id="eis_holder">
                <div id="eis_sidebar">
                    <hr>
                    <a href="{{url('/sekretariat')}}" @if(\Request::is('sekretariat')) class='active' @endif><q class="fa fa-home fa-2x"></q>Home</a>
                    <a href="{{url('/sekretariat/profile')}}" @if(\Request::is('sekretariat/profile')) class='active' @endif><q class="fa fa-users fa-2x"></q>Profile Sekertariat</a>
                    <a href="{{url('/sekretariat/daftarkelas')}}" @if(\Request::is('sekretariat/daftarkelas')) class='active' @endif><q class="fa fa-file fa-2x"></q>Daftar Kelas Wali</a>
                    <a href="{{url('/sekretariat/lfrs')}}" @if(\Request::is('sekretariat/frs')) class='active' @endif><q class="fa fa-file fa-2x"></q>Lihat Rencana Studi</a>
                    <a href="{{url('/sekretariat/niali')}}" @if(\Request::is('sekretariat/frs')) class='active' @endif><q class="fa fa-file fa-2x"></q>Nilai</a>
                    <a href="{{url('/sekretariat/presensi')}}" @if(\Request::is('sekretariat/presensi')) class='active' @endif><q class="fa fa-file fa-2x"></q>Perkuliahan & Presensi</a>
