...
<div id="eis_main">
    ...
    <div style="padding:5px;padding-bottom:10px">
      <div class="td-box td-box-full">
        <div class="td-box-title">Data Jurusan</div>
        <div style="font-size:14px;padding:10px;">
          <button type="button" id="addJurusan" class="btn btn-success">
            <i class="fa fa-plus"></i>
          </button>
          <div style="padding:5px"></div>
          <div class="table-responsive">
            <table class="table" id="mainJurusan">
              <thead>
                <th>No</th>
                <th>Nama Jurusan</th>
                <th>Aksi</th>
    ...
    <div style="padding:5px;padding-bottom:10px">
        <div class="td-box td-box-full">
          <div class="td-box-title">Data Administrator Jurusan</div>
          <div style="font-size:14px;padding:10px;">
            <button type="button" id="addAdmin" class="btn btn-success">
              <i class="fa fa-plus"></i>
            </button>
            <div style="padding:5px"></div>
            <div class="table-responsive">
              <table class="table" id="mainAdmin">
              <thead>
                <th>No</th>
                <th>Nama</th>
                <th>Username</th>
