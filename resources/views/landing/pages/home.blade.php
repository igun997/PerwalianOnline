...
<div id="eis_main">
    ...
    <div style="padding:5px;padding-bottom:10px">
        <div class="td-box td-box-full">
            <div class="td-box-title">Selamat Datang di Perwalian Online</div>
            <div style="font-size:14px;text-align:justify;padding:10px;"></div>
        </div>
    </div>
    <div style="padding:5px;padding-bottom:10px">
        <div class="td-box td-box-full">
            <div class="td-box-title">Pengumuman Perkuliahan</div>
    ...
    <div style="padding:5px;padding-bottom:10px">
        <div class="td-box td-box-full">
            <div class="td-box-title">Kalender Akademik</div>
        </div>
    </div>
</div>
