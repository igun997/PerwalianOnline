    ...
    <div id="eis_all" >
        <div>
            <div id="eis_holder">
                <div id="eis_sidebar">
                    <hr>
                    <a href="{{url('')}}" @if(\Request::is('/')) class='active' @endif><q class="fa fa-home fa-2x"></q>Home</a>
                    <a href="{{url('/masuk')}}" @if(\Request::is('masuk')) class='active' @endif><q class="fa fa-sign-in fa-2x"></q>Masuk</a>
                </div>
